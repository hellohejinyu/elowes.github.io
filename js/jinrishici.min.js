 ...
 */
const keyName="jinrishici-token";function load(e,n){return window.localStorage&&window.localStorage.getItem(keyName)?commonLoad(e,n,window.localStorage.getItem(keyName)):corsLoad(e,n)}function corsLoad(e,n){return sendRequest(function(n){window.localStorage.setItem(keyName,n.token),e(n)},n,"https://v2.jinrishici.com/one.json?client=npm-sdk/1.0")}function commonLoad(e,n,o){return sendRequest(e,n,"https://v2.jinrishici.com/one.json?client=npm-sdk/1.0&X-User-Token="+encodeURIComponent(o))}function sendRequest(e,n,o){var t=new XMLHttpRequest;t.open("get",o),t.withCredentials=!0,t.send(),t.onreadystatechange=function(){if(4===t.readyState){var o=JSON.parse(t.responseText);"success"===o.status?e(o):n?n(o):console.error("今日诗词API加载失败，错误原因："+o.errMessage)}}}export{load};
//# sourceMappingURL=/sm/4e774755c9e1afe2c39dc82bb685cbe55e72466162b1201e61ba50f1e8c3459c.map